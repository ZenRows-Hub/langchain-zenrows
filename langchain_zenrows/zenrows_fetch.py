"""Zenrows Fetch integration for LangChain."""
...
class ZenrowsFetchInput(BaseModel):
...
class ZenrowsFetch(BaseTool):
    """Zenrows Fetch tool for LangChain.

    This tool provides access to Zenrows' Fetch API, enabling reliable web scraping
    with advanced features like JavaScript rendering, premium proxies, and anti-bot
    bypass.
    ...
    args_schema: Type[BaseModel] = ZenrowsFetchInput
    ...
    def __init__(self, zenrows_api_key: Optional[str] = None, **kwargs):
        """Initialize the Zenrows Fetch tool.
    ...
    def _run(self, **kwargs) -> str:
        """Execute the Zenrows Fetch request.
